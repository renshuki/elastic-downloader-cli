...
// hanging forever on the spinner. Enforced in two layers: the axios timeout
// covers the connection and response headers, and a watchdog in download()
// covers the transfer itself (since axios 1.x the timeout option no longer
// aborts an established transfer). Large downloads are fine as long as
// bytes keep arriving.
