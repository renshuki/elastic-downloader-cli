...
// Socket idle timeout: aborts when the server stops sending data for this
// long (before or during the transfer), instead of hanging forever on the
// spinner. Large downloads are fine as long as bytes keep arriving.
